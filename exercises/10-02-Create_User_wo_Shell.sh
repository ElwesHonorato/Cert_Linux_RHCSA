# Crie um usuário chamado “tester” e ele não tem acesso a uma shell.
...
# In case you forget, you can find the path to /etc/passwd in man useradd files section at the bottom.
[root@dev1 ~]# man useradd
# In case you forget, you can get the exact sintax for /sbin/nologin in /etc/passwd
[root@dev1 ~]# tail /etc/passwd
    ...
    tina:x:2700:2700::/home/tina:/bin/bash

[root@dev1 ~]# useradd -s /sbin/nologin tester
[root@dev1 ~]# tail /etc/passwd
    dnsmasq:x:980:978:Dnsmasq DHCP and DNS server:/var/lib/dnsmasq:/usr/sbin/nologin
    tcpdump:x:72:72::/:/sbin/nologin
    elwes:x:1000:1000:elwes:/home/elwes:/bin/bash
